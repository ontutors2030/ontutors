...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OPTFS.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OPTFS.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OPTFS.Models.Chat", b =>
                {
                    b.HasOne("OPTFS.Models.ApplicationUser", "User1")
                        .WithMany()
                        .HasForeignKey("User1Id");

                    b.HasOne("OPTFS.Models.ApplicationUser", "User2")
                        .WithMany()
            ...
            modelBuilder.Entity("OPTFS.Models.ChatMessage", b =>
                {
                    b.HasOne("OPTFS.Models.Chat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId");

                    b.HasOne("OPTFS.Models.ApplicationUser", "Reciever")
                        .WithMany()
                        .HasForeignKey("RecieverId");

                    b.HasOne("OPTFS.Models.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("OPTFS.Models.StudentCourse", b =>
                {
                    ...
                    b.HasOne("OPTFS.Models.StudentRequest", "Request")
                        .WithMany()
